...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 1   // Set default power-up brightness (0-255, requires PWM pin)
 ...
 * The photo can be triggere d by a digital pin or a physical movement.
 */
#define PHOTO_GCODE
#if ENABLED(PHOTO_GCODE)
  // A position to move to (and raise Z) before taking the photo
  //#define PHOTO_POSITION { X_MAX_POS - 5, Y_MAX_POS, 0 }  // { xpos, ypos, zraise } (M240 X Y Z)
  #define PHOTO_POSITION { 0, 100, 0 }  // { xpos, ypos, zraise } (M240 X Y Z)
  #define PHOTO_DELAY_MS   150                            // (ms) Duration to pause before moving back (M240 P)
 ...
 * 
 */
#define PRE_LED_BRIGHTNESS 0;

#define CUSTOM_USER_MENUS
#if ENABLED(CUSTOM_USER_MENUS)
    #define CUSTOM_USER_MENU_TITLE "Preferences"
//  #define USER_SCRIPT_DONE "M117 User Script Done"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
//  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Toggle Light"
  #define USER_GCODE_1 "M355 S"
